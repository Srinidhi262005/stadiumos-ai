  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const demoUser = {
        ...
        email,
        role: 'admin' as const,
        permissions: ['admin', 'ops', 'volunteer'],
      };

      localStorage.setItem('demo-auth', 'true');
      localStorage.setItem('stadium_user', JSON.stringify(demoUser));
      ...
      addNotification({
        ...
        description:
          'Welcome to StadiumOS AI Decision Command Center.',
        category: 'system',
        severity: 'success',
      });
      ...
      setErrors({
        general: 'Unable to start demo mode.',
      });

      addNotification({
        title: 'Authentication Failed',
        description: 'Unable to launch demo.',
        category: 'system',
        severity: 'danger',
      });
    } finally {
      ...
      >
        ...
        {errors.general && (
          <motion.div
            ...
            className="flex items-start gap-2.5 p-3.5 mb-6 rounded-lg bg-red-500/10 border border-red-500/30 text-red-400 text-xs"
          >
            <ShieldAlert
              size={16}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="space-y-1.5">
            ...
            {errors.email && (
              <span className="text-[10px] text-red-400 font-medium block mt-0.5">
                {errors.email}
              </span>
            )}
          </div>
